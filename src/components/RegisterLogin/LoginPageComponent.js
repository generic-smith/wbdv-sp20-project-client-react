    ...
    return (
        <div className="body stretch-down">
          <div className="container">
            ...
            {this.state.failedLogin === 3 && <ErrorMessage
                msg="Cannot login as guest"/>}
            {this.state.failedLogin === 4 && <ErrorMessage
                msg="Cannot login in as empty user"/>}
            <h1>Sign In</h1>
            <form>
              ...
              <div className="form-group row">
                ...
                <label className="col-sm-10" id="signUp">
                  ...
                  <Link class="float-right" to={"/home"}> Sign in as
                    Guest</Link>
                </label>
